# Author: Victor Vu
# File: turb_sensor.py
# Description: Script for reading analog voltage from a turbidity sensor connected to an ADS1115 module
...
i2c = busio.I2C(
    board.SCL, board.SDA
)  # I2C interface that reads from GPIO pins SCL and SDA
